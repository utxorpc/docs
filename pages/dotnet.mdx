...
Here’s how you can start using the `SyncServiceClient` to interact with the UTXO RPC service.
...
The `FollowTipAsync` method allows you to receive real-time updates as the blockchain progresses. You need to provide a `BlockRef` to indicate where you want to start following.
